...
<html lang="en">
    <head>
        ...
        <title>Fruits and Veggie | Manage Out for Delivery Orders</title>
...
<span class="badge bg-secondary">In Transit</span>
    <?php elseif($ostatus=='Out For Delivery'):?>
        <span class="badge bg-dark">Out For Delivery</span>
        ...
        <?php endif;?>
                                            ...
                                            <td>
                                            <a href="order-details.php?orderid=<?php echo $row['id']?>" target="_blank" class="btn btn-primary btn-sm">
                                              View Details</a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
                                    </tbody>
