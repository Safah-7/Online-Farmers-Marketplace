...
<html lang="en">
    <head>
        ...
        <title>Fruits and Veggie | Add Category</title>
...
<div class="col-8"><textarea placeholder="Enter description"  name="description" class="form-control" required></textarea></div>
</div>

<div class="row" style="margin-top:1%;">
<div class="col-8" align="right"><button type="submit" name="submit" class="btn btn-primary">Submit</button></div>
</div>
