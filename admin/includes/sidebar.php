...
?>           <a class="nav-link" href="all-orders.php">All Orders <span style="color:red"> [<?php echo $torders;?>]</span></a>
            <a class="nav-link" href="new-order.php">New Orders <span style="color:red"> [<?php echo $norders;?>]</span></a>
            <a class="nav-link" href="packed-orders.php">Packed Orders <span style="color:red"> [<?php echo $porders;?>]</span></a>
            <a class="nav-link" href="dispatched-orders.php">Dispatched Order <span style="color:red"> [<?php echo $dtorders;?>]</span></a>
            <a class="nav-link" href="intransit-orders.php">In Transit Order <span style="color:red"> [<?php echo $intorders;?>]</span></a>
            <a class="nav-link" href="outfordelivery-orders.php">Out for Devlivery Order <span style="color:red"> [<?php echo $otforders;?>]</span></a>
            <a class="nav-link" href="delivered-orders.php">Delivered Order <span style="color:red"> [<?php echo $deliveredorders;?>]</span></a>
            <a class="nav-link" href="cancelled-orders.php">Cancelled Order <span style="color:red"> [<?php echo $cancelledorders;?>]</span></a>
                                </nav>
                            </div>
