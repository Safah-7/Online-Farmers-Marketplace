...
<html lang="en">
    <head>
        ...
        <title>Fruits and Veggie | Admin Dashboard</title>
          ...
          <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-secondary  text-white h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-white-75 small">Listed Products </div>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-white stretched-link" href="manage-products.php">View Requests</a>
                                    </div>
                                </div>
                            </div>
