...
$sql=mysqli_query($con,"insert into products(category,subCategory,productName,variety,Availablein,Quantity,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount,addedBy) values('$category','$subcat','$productname','$variety','$availableIn','$quantity','$productprice','$productdescription','$productscharge','$productavailability','$imgnewfile1','$imgnewfile2','$imgnewfile3','$productpricebd','$addedby')");
...
<html lang="en">
    <head>
        ...
        <title>Fruits and Veggie | Add Products</title>
...
<div class="col-8"><input type="text"    name="variety"  placeholder="Enter Product variety" class="form-control">
...
<div class="col-8"><input type="text"    name="productpricebd"  placeholder="Enter Product Price" class="form-control" required>
</select>
</div>
</div>
...
<div class="row">
<div class="col-8"><button type="submit" name="submit" class="btn btn-primary">Submit</button></div>
</div>
