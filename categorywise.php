...
{ ?>
            ...
            <div class="row product-lists">
                ...
                $query=mysqli_query($con,"select products.id as pid,products.productImage1,products.productName,products.Quantity,products.productPriceBeforeDiscount,products.productPrice from products where category='$cid' order by pid desc LIMIT $offset, $total_records_per_page ");
                $count=mysqli_num_rows($query);
if($count>0){
