...
<head>
	...
	<!-- title -->
	<title>Fruits and Veggie|| Registration page</title>
...
<form method="post" name="signup">
     <div class="row">
         <div class="col-4" style="font-size:18px;font-weight: bolder;">Full Name</div>
 ...
 <span id="user-email-status" style="font-size:12px;"></span>
       ...
       <div class="row mt-3">
         <div class="col-4" style="font-size:18px;font-weight: bolder;">Contact Number</div>
